...
#define    TMR__UINT8_MODE_TIMER        TMR_IN_NORMAL_MODE 
...
*/
#define    TMR__UINT8_COMPARE_MATCH_OUTPUT_FAST_PWM  TMR_CMOMODE_OC0_DISCONNECTED
/*
option of COMPARE MATCH OUTPUT IN  FAST PWM MODE
   0-TMR_CMOMODE_OC0_DISCONNECTED
...
*/
#define    TMR__UINT8_COMPARE_MATCH_OUTPUT_PHASE_CORRECT  TMR_CMOMODE_OC0_DISCONNECTED
...
*/
#define   TMR__UINT8_SELECT_TIMER       TMR_NO_CLK_SOURCE
